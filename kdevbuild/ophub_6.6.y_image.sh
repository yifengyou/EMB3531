...
export BUILD_TAG="EMB3531_k6.6.y_${set_rootfs}"
...
wget -c https://github.com/yifengyou/EMB3531/releases/download/ophub-kernel-6.6.y/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/EMB3531/releases/download/ophub-kernel-6.6.y/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/EMB3531/releases/download/ophub-kernel-6.6.y/config-6.6.y-kdev
ls -alh config-6.6.y-kdev
md5sum config-6.6.y-kdev

wget -c https://github.com/yifengyou/EMB3531/releases/download/ophub-kernel-6.6.y/System.map-6.6.y-kdev
ls -alh System.map-6.6.y-kdev
md5sum System.map-6.6.y-kdev

wget -c https://github.com/yifengyou/EMB3531/releases/download/ophub-kernel-6.6.y/rk3399-emb3531.dtb
ls -alh rk3399-emb3531.dtb
md5sum rk3399-emb3531.dtb

wget -c https://github.com/yifengyou/EMB3531/releases/download/ophub-kernel-6.6.y/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
...
cp -a ${WORKDIR}/rockchip-tools.git/RKDevTool-EMB3531 \
