...
export BUILD_TAG="OWL_lbc-develop-6.1_${set_rootfs}"
...
wget -c https://github.com/yifengyou/rk3399-owl-ai-box-plus/releases/download/lubancat_lbc-develop-6.1_kernel/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/rk3399-owl-ai-box-plus/releases/download/lubancat_lbc-develop-6.1_kernel/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/rk3399-owl-ai-box-plus/releases/download/lubancat_lbc-develop-6.1_kernel/config-6.1-kdev
ls -alh config-6.1-kdev
md5sum config-6.1-kdev

wget -c https://github.com/yifengyou/rk3399-owl-ai-box-plus/releases/download/lubancat_lbc-develop-6.1_kernel/System.map-6.1-kdev
ls -alh System.map-6.1-kdev
md5sum System.map-6.1-kdev

wget -c https://github.com/yifengyou/rk3399-owl-ai-box-plus/releases/download/lubancat_lbc-develop-6.1_kernel/rk3399-emb3531.dtb
ls -alh rk3399-emb3531.dtb
md5sum rk3399-emb3531.dtb

wget -c https://github.com/yifengyou/rk3399-owl-ai-box-plus/releases/download/lubancat_lbc-develop-6.1_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
