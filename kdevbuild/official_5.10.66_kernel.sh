...
#==========================================================================#
cd ${WORKDIR}/
git clone https://github.com/yifengyou/rk3399-owl-ai-box-plus-uboot u-boot.git
cd u-boot.git
ls -alh
...
# build uboot.img
chmod +x make.sh
./make.sh rk3399 --burn-key-hash CROSS_COMPILE=aarch64-linux-gnu-
...
#==========================================================================#
cd ${WORKDIR}
git clone https://github.com/yifengyou/rk3399-owl-ai-box-plus-kernel kernel.git
cd kernel.git
ls -alh
